...
# Ensure we're running under bash even if invoked as `sh create_command.sh`
...
usage() {
	cat <<'USAGE'
Usage: ./create_command.sh [--user <github_user>] [--repo <repo_name>] [--domain <custom.domain>] [--yes]
